...
echo_and_run cd "/home/casch/ws_moveit/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/casch/ws_moveit/src/universal_robot/ur_kinematics/setup.py" \
    build --build-base "/home/casch/ws_moveit/build/universal_robot/ur_kinematics" \
    install \
    $DESTDIR_ARG \
