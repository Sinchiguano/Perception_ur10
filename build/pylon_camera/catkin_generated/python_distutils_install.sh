...
echo_and_run cd "/home/casch/ws_moveit/src/pylon_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/casch/ws_moveit/src/pylon_camera/setup.py" \
    build --build-base "/home/casch/ws_moveit/build/pylon_camera" \
    install \
    $DESTDIR_ARG \
