...
if("TRUE" STREQUAL "TRUE")
  set(visp_camera_calibration_SOURCE_PREFIX /home/casch/ws_moveit/src/vision_visp/visp_camera_calibration)
  set(visp_camera_calibration_DEVEL_PREFIX /home/casch/ws_moveit/devel)
  ...
  set(visp_camera_calibration_INSTALL_PREFIX /home/casch/ws_moveit/install)
...
if(NOT "/home/casch/ws_moveit/devel/include;/opt/ros/melodic/include;/usr/include;/usr/include/opencv;/usr/include/eigen3;/usr/include/libxml2;/usr/include/OGRE;/usr/include/ois " STREQUAL " ")
  set(visp_camera_calibration_INCLUDE_DIRS "")
  set(_include_dirs "/home/casch/ws_moveit/devel/include;/opt/ros/melodic/include;/usr/include;/usr/include/opencv;/usr/include/eigen3;/usr/include/libxml2;/usr/include/OGRE;/usr/include/ois")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visp_camera_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/ws_moveit/src/vision_visp/visp_camera_calibration/${idir}'.  ${_report}")
    endif()
    _list_append_unique(visp_camera_calibration_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/opt/ros/melodic/lib/libvisp_vs.so.3.2.0;/opt/ros/melodic/lib/libvisp_visual_features.so.3.2.0;/opt/ros/melodic/lib/libvisp_vision.so.3.2.0;/opt/ros/melodic/lib/libvisp_tt_mi.so.3.2.0;/opt/ros/melodic/lib/libvisp_tt.so.3.2.0;/opt/ros/melodic/lib/libvisp_me.so.3.2.0;/opt/ros/melodic/lib/libvisp_mbt.so.3.2.0;/opt/ros/melodic/lib/libvisp_klt.so.3.2.0;/opt/ros/melodic/lib/libvisp_blob.so.3.2.0;/opt/ros/melodic/lib/libvisp_sensor.so.3.2.0;/opt/ros/melodic/lib/libvisp_robot.so.3.2.0;/opt/ros/melodic/lib/libvisp_io.so.3.2.0;/opt/ros/melodic/lib/libvisp_imgproc.so.3.2.0;/opt/ros/melodic/lib/libvisp_gui.so.3.2.0;/opt/ros/melodic/lib/libvisp_detection.so.3.2.0;/opt/ros/melodic/lib/libvisp_core.so.3.2.0;/opt/ros/melodic/lib/libvisp_ar.so.3.2.0")
