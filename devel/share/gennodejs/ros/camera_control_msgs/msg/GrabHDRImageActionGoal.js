...
class GrabHDRImageActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new GrabHDRImageGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GrabHDRImageGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GrabHDRImageGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GrabHDRImageActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GrabHDRImageGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GrabHDRImageGoal()
    }
...
module.exports = GrabHDRImageActionGoal;
