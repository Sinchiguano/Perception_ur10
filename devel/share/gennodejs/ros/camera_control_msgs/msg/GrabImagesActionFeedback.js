...
class GrabImagesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GrabImagesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GrabImagesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GrabImagesActionFeedback(null);
    ...
    data.feedback = GrabImagesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GrabImagesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GrabImagesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GrabImagesFeedback()
    }
...
module.exports = GrabImagesActionFeedback;
