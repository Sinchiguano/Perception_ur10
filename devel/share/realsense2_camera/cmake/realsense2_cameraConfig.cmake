...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/casch/ws_moveit/src/realsense-2.2.0/realsense2_camera)
...
if(NOT "/home/casch/ws_moveit/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/ws_moveit/src/realsense-2.2.0/realsense2_camera/${idir}'.  ${_report}")
    endif()
