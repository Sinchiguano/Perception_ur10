...
"""autogenerated by genpy from easy_handeye/RemoveSampleRequest.msg. Do not edit."""
import sys
...
class RemoveSampleRequest(genpy.Message):
  ...
  _type = "easy_handeye/RemoveSampleRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_b().pack(self.sample_index))
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from easy_handeye/RemoveSampleResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class RemoveSampleResponse(genpy.Message):
  ...
  _type = "easy_handeye/RemoveSampleResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class RemoveSample(object):
  _type          = 'easy_handeye/RemoveSample'
  _md5sum = 'f2b56f3f27d9d8404f22e6fe88f38b19'
