...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_control_msgs-srv:<SetBool-request> is deprecated: use camera_control_msgs-srv:SetBool-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetBool-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_control_msgs-srv:data-val is deprecated.  Use camera_control_msgs-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBool-request>)))
  ...
  "camera_control_msgs/SetBoolRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBool-request)))
  "Returns string type for a service object of type 'SetBool-request"
  "camera_control_msgs/SetBoolRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_control_msgs-srv:<SetBool-response> is deprecated: use camera_control_msgs-srv:SetBool-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBool-response>)))
  ...
  "camera_control_msgs/SetBoolResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBool-response)))
  "Returns string type for a service object of type 'SetBool-response"
  "camera_control_msgs/SetBoolResponse")
