...
class GrabHDRImageActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GrabHDRImageFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GrabHDRImageFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GrabHDRImageActionFeedback(null);
    ...
    data.feedback = GrabHDRImageFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GrabHDRImageActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GrabHDRImageFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GrabHDRImageFeedback()
    }
...
module.exports = GrabHDRImageActionFeedback;
