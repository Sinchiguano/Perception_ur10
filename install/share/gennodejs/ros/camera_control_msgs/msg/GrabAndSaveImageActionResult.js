...
class GrabAndSaveImageActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new GrabAndSaveImageResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GrabAndSaveImageResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GrabAndSaveImageActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = GrabAndSaveImageResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GrabAndSaveImageActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GrabAndSaveImageResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GrabAndSaveImageResult()
    }
...
module.exports = GrabAndSaveImageActionResult;
