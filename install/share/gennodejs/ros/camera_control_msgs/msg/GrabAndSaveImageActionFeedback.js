...
class GrabAndSaveImageActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GrabAndSaveImageFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GrabAndSaveImageFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GrabAndSaveImageActionFeedback(null);
    ...
    data.feedback = GrabAndSaveImageFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GrabAndSaveImageActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GrabAndSaveImageFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GrabAndSaveImageFeedback()
    }
...
module.exports = GrabAndSaveImageActionFeedback;
