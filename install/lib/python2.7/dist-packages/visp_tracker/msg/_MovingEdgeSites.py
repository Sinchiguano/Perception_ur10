...
"""autogenerated by genpy from visp_tracker/MovingEdgeSites.msg. Do not edit."""
import sys
...
class MovingEdgeSites(genpy.Message):
  _md5sum = "5293e8601467590a0dabbb34da47310c"
  _type = "visp_tracker/MovingEdgeSites"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Stamped list of moving edge positions.
#
...
"""
  __slots__ = ['header','moving_edge_sites']
  _slot_types = ['std_msgs/Header','visp_tracker/MovingEdgeSite[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MovingEdgeSites, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.moving_edge_sites is None:
        self.moving_edge_sites = []
    else:
      self.header = std_msgs.msg.Header()
      self.moving_edge_sites = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.moving_edge_sites)
      buff.write(_struct_I.pack(length))
      for val1 in self.moving_edge_sites:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = visp_tracker.msg.MovingEdgeSite()
        _x = val1
        start = end
        end += 20
        (_x.x, _x.y, _x.suppress,) = _get_struct_2di().unpack(str[start:end])
        self.moving_edge_sites.append(val1)
      return self
