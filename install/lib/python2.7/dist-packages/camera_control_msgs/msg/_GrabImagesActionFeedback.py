...
"""autogenerated by genpy from camera_control_msgs/GrabImagesActionFeedback.msg. Do not edit."""
import sys
...
class GrabImagesActionFeedback(genpy.Message):
  _md5sum = "e8777b4b2b3ceebb4605036c2a0f61bb"
  _type = "camera_control_msgs/GrabImagesActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','camera_control_msgs/GrabImagesFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GrabImagesActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = camera_control_msgs.msg.GrabImagesFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = camera_control_msgs.msg.GrabImagesFeedback()
