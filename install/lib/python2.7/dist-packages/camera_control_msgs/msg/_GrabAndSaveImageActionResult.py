...
"""autogenerated by genpy from camera_control_msgs/GrabAndSaveImageActionResult.msg. Do not edit."""
import sys
...
class GrabAndSaveImageActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "camera_control_msgs/GrabAndSaveImageActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','camera_control_msgs/GrabAndSaveImageResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GrabAndSaveImageActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = camera_control_msgs.msg.GrabAndSaveImageResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = camera_control_msgs.msg.GrabAndSaveImageResult()
