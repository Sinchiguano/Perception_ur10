...
"""autogenerated by genpy from camera_control_msgs/GrabHDRImageActionFeedback.msg. Do not edit."""
import sys
...
class GrabHDRImageActionFeedback(genpy.Message):
  _md5sum = "e8777b4b2b3ceebb4605036c2a0f61bb"
  _type = "camera_control_msgs/GrabHDRImageActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','camera_control_msgs/GrabHDRImageFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GrabHDRImageActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = camera_control_msgs.msg.GrabHDRImageFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = camera_control_msgs.msg.GrabHDRImageFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.feedback.curr_nr_images_taken))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.curr_nr_images_taken,) = _get_struct_i().unpack(str[start:end])
      return self
