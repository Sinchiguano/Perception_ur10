...
class GrabHDRImageResult(genpy.Message):
  _md5sum = "d4cf4ee23b359159c6593b91d560971e"
...
bool do_rectify
"""
  __slots__ = ['hdr_image','cam_info','reached_exposure_times','reached_brightness_values','reached_gain_values','reached_gamma_values','success']
  _slot_types = ['sensor_msgs/Image','sensor_msgs/CameraInfo','float32[]','float32[]','float32[]','float32[]','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       hdr_image,cam_info,reached_exposure_times,reached_brightness_values,reached_gain_values,reached_gamma_values,success
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.hdr_image.header.seq, _x.hdr_image.header.stamp.secs, _x.hdr_image.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.hdr_image.height, _x.hdr_image.width))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.hdr_image.is_bigendian, _x.hdr_image.step))
      ...
      _x = self
      buff.write(_get_struct_6IB().pack(_x.cam_info.binning_x, _x.cam_info.binning_y, _x.cam_info.roi.x_offset, _x.cam_info.roi.y_offset, _x.cam_info.roi.height, _x.cam_info.roi.width, _x.cam_info.roi.do_rectify))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.hdr_image.header.seq, _x.hdr_image.header.stamp.secs, _x.hdr_image.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.hdr_image.height, _x.hdr_image.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.hdr_image.is_bigendian, _x.hdr_image.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.cam_info.binning_x, _x.cam_info.binning_y, _x.cam_info.roi.x_offset, _x.cam_info.roi.y_offset, _x.cam_info.roi.height, _x.cam_info.roi.width, _x.cam_info.roi.do_rectify,) = _get_struct_6IB().unpack(str[start:end])
