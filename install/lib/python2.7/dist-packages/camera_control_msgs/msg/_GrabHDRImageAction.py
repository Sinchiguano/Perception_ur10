...
"""autogenerated by genpy from camera_control_msgs/GrabHDRImageAction.msg. Do not edit."""
import sys
...
class GrabHDRImageAction(genpy.Message):
  _md5sum = "607925c69f6405ab0b5d1a3b7c91f130"
  _type = "camera_control_msgs/GrabHDRImageAction"
...
"""
  ...
  _slot_types = ['camera_control_msgs/GrabHDRImageActionGoal','camera_control_msgs/GrabHDRImageActionResult','camera_control_msgs/GrabHDRImageActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GrabHDRImageAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = camera_control_msgs.msg.GrabHDRImageActionGoal()
      if self.action_result is None:
        self.action_result = camera_control_msgs.msg.GrabHDRImageActionResult()
      if self.action_feedback is None:
        self.action_feedback = camera_control_msgs.msg.GrabHDRImageActionFeedback()
    else:
      self.action_goal = camera_control_msgs.msg.GrabHDRImageActionGoal()
      self.action_result = camera_control_msgs.msg.GrabHDRImageActionResult()
      self.action_feedback = camera_control_msgs.msg.GrabHDRImageActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.action_goal.goal.exposure_fixed, _x.action_goal.goal.brightness_given))
      length = len(self.action_goal.goal.brightness_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.brightness_values))
      _x = self
      buff.write(_get_struct_2B().pack(_x.action_goal.goal.brightness_continuous, _x.action_goal.goal.gain_given))
      length = len(self.action_goal.goal.gain_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.gain_values))
      _x = self
      buff.write(_get_struct_2B().pack(_x.action_goal.goal.gain_fixed, _x.action_goal.goal.gamma_given))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.hdr_image.header.seq, _x.action_result.result.hdr_image.header.stamp.secs, _x.action_result.result.hdr_image.header.stamp.nsecs))
      _x = self.action_result.result.hdr_image.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_result.result.hdr_image.height, _x.action_result.result.hdr_image.width))
      _x = self.action_result.result.hdr_image.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.action_result.result.hdr_image.is_bigendian, _x.action_result.result.hdr_image.step))
      _x = self.action_result.result.hdr_image.data
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.exposure_fixed, _x.action_goal.goal.brightness_given,) = _get_struct_2B().unpack(str[start:end])
      self.action_goal.goal.exposure_fixed = bool(self.action_goal.goal.exposure_fixed)
      ...
      (_x.action_goal.goal.brightness_continuous, _x.action_goal.goal.gain_given,) = _get_struct_2B().unpack(str[start:end])
      self.action_goal.goal.brightness_continuous = bool(self.action_goal.goal.brightness_continuous)
      ...
      (_x.action_goal.goal.gain_fixed, _x.action_goal.goal.gamma_given,) = _get_struct_2B().unpack(str[start:end])
      self.action_goal.goal.gain_fixed = bool(self.action_goal.goal.gain_fixed)
      ...
      (_x.action_result.result.hdr_image.header.seq, _x.action_result.result.hdr_image.header.stamp.secs, _x.action_result.result.hdr_image.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.hdr_image.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.hdr_image.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.action_result.result.hdr_image.height, _x.action_result.result.hdr_image.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.hdr_image.encoding = str[start:end].decode('utf-8')
      else:
        self.action_result.result.hdr_image.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.action_result.result.hdr_image.is_bigendian, _x.action_result.result.hdr_image.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_result.result.hdr_image.data = str[start:end]
      _x = self
      start = end
      end += 12
