...
home_cad=[-0.13014346757997686, -1.4165681044207972, 1.6880431175231934,-0.8233225981341761, 1.6053203344345093,  0.14447395503520966]
home_cad_1= [-0.1416714827166956,  -1.6609728972064417,  1.9717884063720703,  -0.861739460621969,  1.594873070716858,  0.15043872594833374]

def main():
    r=rospy.Rate(10)
    print "============ Press `Enter` to go to home-position ==> (CAD model)..."
    raw_input()
    object_ur10.go_to_joint_state(home_cad_1)
    ...
    while(not rospy.is_shutdown()):
        try:
            ...
            #object_ur10.retime_trajectory(cartesian_plan, velocity_scaling_factor=1.0, acceleration_scaling_factor=1.0, algorithm="iterative_time_parameterization")
            #time.sleep(2)
