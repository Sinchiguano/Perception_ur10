...
class UniversalRobot(object):
  ...
  def go_to_pose_goal(self):
    ...
    pose_goal.orientation.x=-0.995768343677
    pose_goal.orientation.y=0.0862601334386
    pose_goal.orientation.z=-0.0235362950451
    pose_goal.orientation.w = 0.0212282341723
    pose_goal.position.x = 0.719001261234
    pose_goal.position.y = 0.0909965194085
    pose_goal.position.z = 0.68285424151
  ...
  def plan_cartesian_path(self, scale=1):
    ...
    wpose.position.x -= scale * 0.5  # Fourth move backwards/left side
    waypoints.append(copy.deepcopy(wpose))
