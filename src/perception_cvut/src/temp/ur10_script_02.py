...
class UniversalRobot(object):
  ...
  def go_to_joint_state(self):
    ...
    #Home Position
    #joint_goal=[-2.4633965132597826, -1.2557086516709122, 1.1967868233077972, -1.3095819780598867, -2.4187453273271315, 0.8608391085669281]
    joint_goal=[-2.3928032271743653, -1.8789438830092242, -1.2001207375840712, 0.04290714159029478, 1.158314714430832, -0.17473331047946952]
