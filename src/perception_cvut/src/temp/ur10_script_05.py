...
class UniversalRobot(object):
  ...
  def __init__(self):
    ...
    move_group.set_max_velocity_scaling_factor(0.35)
...
goal_1.orientation.x,goal_1.orientation.y,goal_1.orientation.z,goal_1.orientation.w=[-0.995768343677,0.0862601334386,-0.0235362950451,0.0212282341723]#xyzw
goal_1.position.x,goal_1.position.y,goal_1.position.z=[0.72,0.40,0.68]#xyz
poses.append(goal_1)

goal_2.orientation.x,goal_2.orientation.y,goal_2.orientation.z,goal_2.orientation.w=[-0.995768343677,0.0862601334386,-0.0235362950451,0.0212282341723]#xyzw
goal_2.position.x,goal_2.position.y,goal_2.position.z=[0.72,0.40,0.38]#xyz
poses.append(goal_2)

goal_3.orientation.x,goal_3.orientation.y,goal_3.orientation.z,goal_3.orientation.w=[-0.995768343677,0.0862601334386,-0.0235362950451,0.0212282341723]#xyzw
goal_3.position.x,goal_3.position.y,goal_3.position.z=[0.72,0.40,0.68]#xyz
poses.append(goal_3)

goal_4.orientation.x,goal_4.orientation.y,goal_4.orientation.z,goal_4.orientation.w=[-0.995768343677,0.0862601334386,-0.0235362950451,0.0212282341723]#xyzw
goal_4.position.x,goal_4.position.y,goal_4.position.z=[0.72,0.40,0.48]#xyz
poses.append(goal_4)

goal_5.orientation.x,goal_5.orientation.y,goal_5.orientation.z,goal_5.orientation.w=[-0.995768343677,0.0862601334386,-0.0235362950451,0.0212282341723]#xyzw
goal_5.position.x,goal_5.position.y,goal_5.position.z=[0.42,0.20,0.68]#xyz
poses.append(goal_5)

goal_6.orientation.x,goal_6.orientation.y,goal_6.orientation.z,goal_6.orientation.w=[-0.995768343677,0.0862601334386,-0.0235362950451,0.0212282341723]#xyzw
goal_6.position.x,goal_6.position.y,goal_6.position.z=[0.62,0.50,0.48]#xyz
poses.append(goal_6)
poses.append(home)
...
def move(object_robot):
    ...
    #moves = [ pose_ee for each in poses]
...
def main():
    ...
    #Task space
    ###########
    print "============ Press `Enter` to start a task Space movement ==> (Home position)..."
    raw_input()
    ...
    while(not rospy.is_shutdown()):
        try:
            ...
            # raw_input()
            # object_ur10.go_to_joint_state(home_position,home_orientation)
            # time.sleep(3)
