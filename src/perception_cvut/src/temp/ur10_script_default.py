...
class UniversalRobot(object):
  ...
  def plan_cartesian_path(self, scale=1):
    ...
    wpose.position.x -= scale * 0.2  # Fourth move backwards/left side
...
def main():
  try:
    ...
    raw_input()
    object_ur10.add_box()
    print "============ Press `Enter` to attach a Box to the ur10 robot ..."
    raw_input()
    ...
    #Remove object
    ###########
    print "============ Press `Enter` to detach the box from the ur10 robot ..."
    raw_input()
